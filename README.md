...
- Vercel UI routes:
  ...
  - Analytics now includes richer fields (`analytics.chapter_counts`, `analytics.schedule_records`, `analytics.updated_on_records`, `analytics.doc_type_counts`, `analytics.unique_page_count`)
